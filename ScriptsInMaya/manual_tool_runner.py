...
from custom_maya_scripts.components import (color_library, button_base, optionMenu_base, window_base, tabLayout_base,
                                            rowColumnLayout_base)
...
def create_ui_window():
    ...
    tabs_ui = tabLayout_base.TabLayoutBase('tabs_ui', imw=5, imh=5)

    color_tab = _ui_setup(tabs_ui.name, 'color')
