columnLayout_arg_map = {
	"adj": {
		"name": "adjustableColumn",
		"description": "Sets the children of the layout to be attached on both sides. They will stretch or shrink"
		" with the layout.",
		"type": "boolean",
	...
	"cal": {
		"name": "columnAlign",
		"description": "Sets the alignment of children containing text or pixmaps. Align values: \"left\" | \"right\""
		" | \"center\".",
		"type": "string",
		"property": "Create|Edit"
	},
	"cat": {
		"name": "columnAttach",
		"description": "Sets the attachment and offsets for the children of the layout. Side values: \"left\" |"
		" \"right\" | \"both\". Left or both is recommended.",
		"type": "[string, int]",
		"property": "Create|Edit"
	},
	"co": {
		"name": "columnOffset",
		"description": "Sets the offsets for children of the layout. Side values: \"left\" | \"right\" | \"both\".",
		"type": "[string, int]",
		"property": "Create|Edit"
	},
	"cw": {
		"name": "columnWidth",
		"description": "Sets the width of the column. Unless the children are attached to both sides of the column,"
	...
	"rs": {
		"name": "rowSpacing",
		"description": "Sets the space between children.",
		"type": "int",
		"property": "Create|Query|Edit"
	},
	"sbm": {
